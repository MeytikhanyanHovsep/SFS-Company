                ...
                { mainPortfolio.filter(e => e.category.includes(activeCategory)).map((elm, ind) =>
                    <div className='flex justify-start'>
                        <Link href={ elm.link } key={ ind }>
                            ...
                            <p className='px-[5px] mt-[10px] text-[#181a25] flex justify-between text-[20px] font-[500]'>
                                <span>{ elm.title }</span>
                                <Image className='max-w-[20px] object-contain' alt='' src='/portfolioImages/share.png' width={ 40 } height={ 40 } />
                            </p>
                        </Link>
                    </div>) }
            </div>
