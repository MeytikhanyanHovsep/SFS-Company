        ...
        <div className='mt-[65px]'>
            ...
            <div className='mb-[115px] md:mb-[90px] sm:mb-[40px] flex md:flex-wrap sm:gap-[15px] container justify-center gap-[45px]'>
                ...
                { categories.map((elm, ind) => (
                    <button className={ `transition-all duration-200 border-[1px] sm:px-[10px] px-[30px] py-[10px] font-[400] rounded-[5px] ${ activeCategory == elm ? "border-[#f301d2] bg-[#f301d2] text-white" : "border-[#ccc] text-[#ccc] bg-white" }` } onClick={ () => setActiveCategory(elm) } key={ ind }>
                        { elm }
                    </button>
                )) }
            </div>
