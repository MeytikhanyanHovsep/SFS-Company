            ...
            <div className='container flex md:flex-col md:items-center justify-between gap-[20px]'>
                ...
                <div className='flex flex-col sm:min-w-full min-h-full relative justify-center lg:gap-[30px] gap-[60px] lg:max-w-max max-w-min'>
                    ...
                    <div className='flex w-full min-h-[270px] xs:justify-between sm:min-w-full xs:min-h-[230px] justify-between items-end gap-[110px] lg:gap-[40px] max-w-[620px] md:gap-[100px] sm:gap-[60px] mx-auto xs:gap-0 max-h-[270px] md:pt-[25px]'>
                        <div className='relative h-full size bg-contain bg-center bg-no-repeat bg-[url(/designDetailsImages/circleDetail3.png)] max-h-[175px] sm:max-h-[120px] xs:max-h-[110px] flex items-center justify-center flex-col p-[20px]'>
                            <Image src="/servicesImages/agreement.png" width={ 55 } height={ 55 } className='max-w-[50px] sm:max-w-[40px] object-contain' alt='agreement' />
                            <p className={ `text-[#337ab7] text-[30px] sm:text-[20px] xs:text-[18px] lg:text-[25px] font-[500] ${ roboto.className }` }>Reliability</p>
                            <Image className='absolute z-[-1] max-w-[45px] bottom-[-5px] rotate-180 right-[-40px] object-contain' src="/designDetailsImages/servicesGroup2.png" alt='' width={ 50 } height={ 50 } />
                        </div>
                        <div className='relative max-h-[175px] sm:max-h-[100px] xs:max-h-[90px] self-start flex bottom-0 items-center justify-center flex-col'>
                            <div className='relative p-[15px]'>
                                <Image src="/servicesImages/insignia.png" width={ 55 } height={ 55 } className='max-w-[50px] sm:max-w-[40px] object-contain' alt='insignia' />
                        ...
                        <div className='relative max-h-[175px] sm:max-h-[100px] xs:max-h-[90px] flex bottom-0 items-center justify-center flex-col pb-[10px]'>
                            <div className='relative p-[15px]'>
                                <Image src="/servicesImages/clock.png" width={ 55 } height={ 55 } className='max-w-[50px] sm:max-w-[40px] object-contain' alt='clock' />
                                <Image src="/designDetailsImages/circleDetail3.png" className='absolute top-0 left-0 object-contain max-w-full z-[-1]' width={ 200 } height={ 200 } alt='' />
                            </div>
