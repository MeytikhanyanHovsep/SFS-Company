        ...
        <div className={ 'w-full relative max-w-[100vw] overflow-x-hidden ' + style }>
            ...
            <div className='container mt-[-50px] sm:mt-0 pt-[60px] grid sm:gap-[20px] grid-cols-3 xs:max-w-max xs:grid-cols-1 gap-[100px] lg:gap-[60px] md:grid-cols-2 justify-between'>
                <div className='flex pt-[55px] pb-[30px] flex-col xs:max-w-[400px] bg-gradient-to-br from-[#a6c1ee] to-[#e2eaf5] justify-center border-[1px] border-[#e4eef7] rounded-[26px] gap-[12px] px-[23px] relative items-center'>
                    <Image alt='graphic-design' src="/servicesImages/graphic-design.png" className='absolute w-[110px] object-contain xs:max-w-[90px] xs:top-[-45px] top-[-55px]' width={ 110 } height={ 110 } />
                    <h3 className={ `font-[500] text-white text-[22px] sm:text-[20px] ${ roboto.className }` }>Graphic Design</h3>
                ...
                <div className='flex flex-col xs:max-w-[400px] px-[15px] pb-[20px] pt-[35px] items-center border-[1px] border-[#e4eef7] rounded-[25px] bg-white'>
                    <div className='relative'>
                        <Image alt='web-dev' src="/servicesImages/web-dev.png" width={ 50 } height={ 50 } />
                    ...
                    <h3 className={ `mt-[25px] mb-[7px] font-[500] text-[22px] text-[#999] sm:text-[20px] ${ roboto.className }` }>Web Development</h3>
                ...
                <div className='flex flex-col xs:max-w-[400px] px-[15px] pb-[20px] pt-[35px] items-center border-[1px] border-[#e4eef7] rounded-[25px] bg-white'>
                    <div className='relative'>
                        <Image alt='smm' src="/servicesImages/globe.png" width={ 50 } height={ 50 } />
                    ...
                    <h3 className={ `mt-[25px] mb-[7px] font-[500] text-[22px] text-[#999] sm:text-[20px] ${ roboto.className }` }>SMM</h3>
                    <p className={ `text-[16px] font-[400] text-[#999] sm:text-[14px] ${ roboto.className }` }>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. </p>
                </div>
            </div>
            <Image src="/designDetailsImages/servicesBigDetail.png" className='z-[-1] absolute bottom-[-100px] left-0 h-[130%] max-h-[600px] max-w-[200px] xs:hidden' alt='' width={ 300 } height={ 1000 } />
