        ...
        <div className='mt-[300px] sm:mt-[50px] lg:mt-[150px] container'>
            ...
            <div className='flex md:grid grid-cols-3 xs:grid-cols-2 justify-center md:px-[70px] px-[50px] items-center bg-gradient-to-br from-[#a6c1ee] to-[#e2eaf5] gap-[85px] lg:gap-[65px] md:gap-[30px] xs:px-[40px] rounded-[26px] py-[35px]'>
                <div className='flex flex-col items-center gap-[8px] sm:gap-[5px]'>
                    ...
                    <p className={ `text-[45px] sm:text-[25px] text-[#999999] ${ roboto.className }` }>01</p>
                    <p className={ `text-[18px] text-[#999999] ${ roboto.className }` }>Discussion</p>
                </div>
                ...
                <div className='flex flex-col items-center gap-[8px] sm:gap-[5px]'>
                    ...
                    <p className={ `text-[55px] sm:text-[25px] text-[#faab8c] ${ roboto.className }` }>02</p>
                    <p className={ `text-[20px] sm:text-[18px] text-[#faab8c] ${ roboto.className }` }>Solution</p>
                </div>
                ...
                <div className='flex flex-col items-center gap-[8px] sm:gap-[5px]'>
                    ...
                    <p className={ `text-[45px] sm:text-[25px] text-[#999999] ${ roboto.className }` }>03</p>
                    <p className={ `text-[18px] text-[#999999] ${ roboto.className }` }>Implementation</p>
                </div>
                <div className='flex xs:hidden justify-center'>
                    <span className='w-[1px] h-[115px] bg-white'></span>
                </div>
                <div className='flex flex-col items-center gap-[8px] sm:gap-[5px]'>
                    ...
                    <p className={ `text-[45px] sm:text-[25px] text-[#999999] ${ roboto.className }` }>04</p>
                    <p className={ `text-[18px] text-[#999999] ${ roboto.className }` }>Support</p>
                </div>
            </div>
        </div>
    )
