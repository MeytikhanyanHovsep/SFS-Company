    ...
    return (
        <div className="container flex justify-between items-center gap-[20px] md:gap-0 sm:flex-col">
            <div className="max-w-[755px] lg:pt-[50px] flex flex-col justify-center">
                <h3 className={ `text-[40px] xs:text-[20px] lg:text-[35px] md:text-[30px] sm:text-[25px] font-[600] text-[#343434] leading-[55px] xs:leading-[30px] sm:leading-[35px] md:leading-[45px] ${ poppins.className }` }>WE OFFER IDEAS THAT RAISE YOUR BUSINESS ABOVE THE EXPECTED.</h3>
