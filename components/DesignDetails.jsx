    ...
    return <>
        <div className='z-[-1] absolute top-0 left-0 w-full overflow-hidden'>
            <div className='relative max-w-min'>
                <Image alt='' src="/designDetailsImages/bigDetail.png" priority width={ 900 } height={ 900 } className='relative left-0 lg:max-w-[600px] top-0 max-w-[800px] object-contain' />
                ...
                <div className='absolute top-[175px] lg:right-[50px] right-[130px]'>
                ...
                <div className='absolute top-[645px] lg:top-[550px] lg:left-[800px] left-[940px]'>
